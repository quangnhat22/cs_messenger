import 'package:app/features/auth/data/sources/local/number_install_app_local_data_src.dart';
...
class FirstOpenAppRepositoryImpl implements FirstOpenAppRepository {
  late final NumberInstallAppLocalDataSource _numberInstallAppDataSource;
