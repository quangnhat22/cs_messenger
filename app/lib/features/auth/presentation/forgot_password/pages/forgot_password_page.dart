...
import 'package:app/features/auth/presentation/forgot_password/controllers/forgot_password_bloc/forgot_password_form_bloc.dart';
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    AppButtonFilledWidget()
                        .setButtonText('Send email'.toUpperCase())
                        .setTextStyle(
                          TextStyle(
