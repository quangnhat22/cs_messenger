        ...
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
              AppTextFieldWidget()
                  .setBloc(
                      context.read<ChangePasswordFormBloc>().currentPassword)
                  .setSuffixButton(SuffixButton.obscureText)
                  .setAutoFillHints([AutofillHints.password])
                  .setDecoration(
                    InputDecoration(
                      labelText: R.strings.currentPassword,
              ...
              AppTextFieldWidget()
                  .setBloc(context.read<ChangePasswordFormBloc>().newPassword)
                  .setSuffixButton(SuffixButton.obscureText)
                  .setAutoFillHints([AutofillHints.password])
                  .setDecoration(
                    InputDecoration(
              ...
              AppTextFieldWidget()
                  .setBloc(
                      context.read<ChangePasswordFormBloc>().confirmNewPassword)
                  .setSuffixButton(SuffixButton.obscureText)
                  .setAutoFillHints([AutofillHints.password])
                  .setDecoration(
                    InputDecoration(
